...
/** m^3 */
export function volumeOfSphere(meters) {
  return (4 / 3) * Math.PI * Math.pow(meters, 3);
}
...
export function energyToMass(joule) {
  return (joule / Math.pow(speedOfLight(), 2)) * 1000;
}
...
export function earthEnergyInUse() {
  ...
  var other = total - people;
  return other + people;
}

/** g */
export function earthMass() {
  return 5.972 * Math.pow(10, 27);
}

/** m */
export function earthRadius() {
  return 6371000;
}

/** m */
export function earthCrustThickness() {
  return 30000;
}

/** g */
export function earthCrustMass() {
  return (
    (1 - Math.pow(1 - earthCrustThickness() / earthRadius(), 3)) * earthMass()
  );
}

/** g */
export function earthResourceAvailable() {
  return earthCrustMass();
}

/** g */
export function earthResourceInUse() {
  return maxMassPerPerson() * earthPopulation();
}
...
export function jouleToEv(joule) {
  return (joule / 1.602176634) * Math.pow(10, -19);
}
...
/** g */
export function maxMassPerPerson() {
  var house = 180000000; //g
  var car = 2500000; //g
  return house + car;
}

export function earthCarryingCapacity() {
  return (
    (earthEnergyIn() + massToEnergy(earthCrustMass())) /
    (maxEnergyPerPerson() + massToEnergy(maxMassPerPerson()))
  );
}
...
export function recommendedChildCountPerFamily() {
  return earthCarryingCapacity() / earthPopulation();
}
...
export function kardeshevNumber() {
  // hank ai says 0.7276
  return (
    (energyInUse() / energyIn() + resourceInUse() / resourceAvailable()) / 2
  );
}
